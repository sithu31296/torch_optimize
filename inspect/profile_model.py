...
if __name__ == '__main__':
    ...
    parser.add_argument('--memory', type=bool, default=True, help='profile memory usage')
    parser.add_argument('--shape', type=bool, default=False, help='profile input shape')
    parser.add_argument('--sort', type=str, default='time_total', help='sort the result by `time_total` or `memory_usage`')
    parser.add_argument('--save', type=bool, default=False, help='save the profile result in json')
